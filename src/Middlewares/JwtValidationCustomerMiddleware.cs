...
public class JwtValidationCustomerMiddleware : IMiddleware
{
    private readonly IJwtValidationCustomerService _jwtValidationService;
    ...
    public JwtValidationCustomerMiddleware(IJwtValidationCustomerService jwtValidationService)
    {
    ...
    public async Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        try
        {
            ...
            {
                Console.WriteLine($"Customer token validation failed: {validationResult.ErrorMessage}");
            ...
            Console.WriteLine($"Customer token validated. UserId: {validationResult.UserId}");
        ...
        {
            Console.WriteLine($"Error during custome JWT validation: {ex.Message}");
